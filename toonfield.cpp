...
void CFieldToon::Init()
{
	...
	m_Shader->Init("x64/Debug/Shader3DNormalMappingVS.cso", "x64/Debug/shader3DToonPS.cso");
}

void CFieldToon::Uninit()
{
	m_Shader->Uninit();
	delete m_Shader;
