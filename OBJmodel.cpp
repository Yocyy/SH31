...
void COBJModel::Load(const char *FileName)
{
...
//モデル読込////////////////////////////////////////////
void COBJModel::LoadObj(const char *FileName, MODEL *Model)
{
...
//マテリアル読み込み///////////////////////////////////////////////////////////////////
void COBJModel::LoadMaterial(const char *FileName, MODEL_MATERIAL **MaterialArray, unsigned short *MaterialNum)
{
	char str[256];
