...
void CPolygon::Init()
{
	...
	vertex[1].Position = XMFLOAT3(300.0f, 0.0f, 0.0f);
	...
	vertex[3].Position = XMFLOAT3(300.0f, 400.0f, 0.0f);
	...
	m_Texture[1]->Load("data/TEXTURE/HALのあいつ.tga");
	...
	m_Shader->Init(VS_FILEPATH , PS_FILEPATH);
}
